...
import { UserPlus, Mail, Key, User as UserIcon, AlertTriangle } from 'lucide-react';
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-white dark:bg-[#0f172a]/60 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl transition-all relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-black tracking-tight text-slate-850 dark:text-slate-100">Create Account</h2>
          <p className="text-slate-500 dark:text-slate-400 text-xs font-semibold mt-1">
            Register to save option lists and access courses
          </p>
        </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-11 p-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-855 rounded-xl text-sm font-semibold outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10"
              />
            </div>
          </div>
        ...
        <div className="h-px bg-slate-200 dark:bg-slate-855 my-6" />
